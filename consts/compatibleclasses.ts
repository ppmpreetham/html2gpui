...
export const ATTR_METHOD_MAP: Record<string, string> = {
  // Events
  onClick: "on_click",
  on_click: "on_click",
...
export const VALID_TEXT_SIZES = ["xs", "sm", "base", "lg", "xl", "2xl", "3xl", "4xl", "5xl"]

export const TAG_DEFAULT_STYLES: Record<string, string> = {
